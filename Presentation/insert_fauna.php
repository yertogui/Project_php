    ...
    <body>
        ...
        <div id="templatemo_content">
            ...
            <div id="main_column">
                    <h2>Insert Fauna</h2>
                  <p>
                         <form action="../Business/FaunaInsertAction.php" method="get">
                        <br>National Park's Fauna</br>
                        <input type="text" name="txtFauna" id="txtNameElement" size="10" class="inputfield" onfocus="clearText(this)" onblur="clearText(this)" />
                        <br>Description</br>
                        ...
                        <input type="submit" name="btnInsertFauna" id="btnInsertElement" value="Insert" alt="Subscribe" class="submitbutton" />
                                   ...
                                   if ($_GET['error'] == "empty_field") {
                                     ?> <p style="color: red">
                                       Empty fields.
                                                    ...
                                                    <?php
                                     } else if ($_GET['error'] == "fauna_exists") {
                                     ?> <p style="color: red">
                                       The Fauna exists in the park.
                                                    </p>
                                                    <?php
