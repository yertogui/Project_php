    ...
    <body>
        ...
        <div id="templatemo_content">
            ...
            <div id="main_column">
                    <h2>Delete Fauna</h2>
                  <p>
                         <form action="../Business/FaunaDeleteAction.php" method="get">
                        <br>National Park's Fauna</br>
                        <input type="text" name="txtFauna" id="txtFauna" size="10" class="inputfield" onfocus="clearText(this)" onblur="clearText(this)" />
                        ...
                        <input type="submit" name="btnDeleteFauna" id="btnDeleteFauna" value="Delete" alt="Subscribe" class="submitbutton" />
                                   ...
                                   if ($_GET['error'] == "empty_field") {
                                     ?> <p style="color: red">
                                       Empty fields.
                                                    ...
                                                    <?php
                                     } else if ($_GET['error'] == "fauna_not_exists") {
                                     ?> <p style="color: red">
                                       The Fauna doesn't exist in the park.
                                                    </p>
                                                    <?php
