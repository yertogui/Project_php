    ...
    <body>
        ...
        <div id="templatemo_content">
            ...
            <div id="main_column">
                    <h2>Delete Flora</h2>
                  <p>
                         <form action="../Business/FloraDeleteAction.php" method="get">
                        <br>National Park's Flora</br>
                        <input type="text" name="txtFlora" id="txtFlora" size="10" class="inputfield" onfocus="clearText(this)" onblur="clearText(this)" />
                        ...
                        <input type="submit" onclick="return validateFieldsDF();" name="btnDeleteFlora" id="btnDeleteFlora" value="Delete" alt="Subscribe" class="submitbutton" />
                                   ...
                                   if ($_GET['error'] == "empty_field") {
                                     ?> <p style="color: red">
                                       Empty fields.
                                                    ...
                                                    <?php
                                     } else if ($_GET['error'] == "flora_not_exists") {
                                     ?> <p style="color: red">
                                       The Flora doesn't exist in the park.
                                                    </p>
                                                    <?php
