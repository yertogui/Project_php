    ...
    <body>
        ...
        <div id="templatemo_content">
            ...
            <div id="main_column">
                  ...
                  <p>
                         <form action="../Business/ElementDeleteAction.php" method="get">
                        <br>National Park's Element</br>
                        <input type="text" name="txtElement" id="txtElement" size="10" class="inputfield" onfocus="clearText(this)" onblur="clearText(this)" />
                        ...
                        <input type="submit" name="btnDeleteElement" id="btnDeleteElement" value="Delete" alt="Subscribe" class="submitbutton" />
                                   ...
                                   if ($_GET['error'] == "empty_field") {
                                     ?> <p style="color: red">
                                       Empty fields.
                                                    ...
                                                    <?php
                                     } else if ($_GET['error'] == "element_not_exists") {
                                     ?> <p style="color: red">
                                       The Element doesn't exist in the park.
                                                    </p>
                                                    <?php
