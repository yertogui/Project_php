...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>National Parks - UPDATE FAUNA</title>
    ...
    <body>
        ...
        <div id="templatemo_content">
            ...
            <div id="main_column">
                ...
                <p>
                    <form action="../Business/FaunaUpdateAction.php" method="get">
                       ...
                       <?php 
                        ...
                        <input type="submit" name="btnSearchFauna" id="btnSearchFauna" value="Search" alt="Subscribe" class="submitbutton" />
                        ...
                        <input type="submit" name="btnUpdateFauna" id="btnUpdateFauna" value="Update" alt="Subscribe" class="submitbutton" />
