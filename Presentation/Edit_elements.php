...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>National Parks - EDIT ELEMENTS</title>
        ...
        <div id="templatemo_content">
            ...
            <div id="main_column">
                  ...
                  <p>
                        <ul>
                            <li>
                                <a href="insert_element.php">Insert new Element</a>
                            </li>
                             
                            <li>
                                <a href="update_element.php">Update Element</a>
                            </li>
                            <li>
                                <a href="delete_element.php">Delete Element</a>
                            </li>
                        </ul>
